...
def seed_videos():
    ...
    video1 = Video(
        ...
        tmdb_id=135157,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/AofSBD.webp",
        video_url="https://www.youtube.com/watch?v=50kLmhGpt1s&ab_channel=NetflixK-Content",
        tite_url="https://endflix-seeds.s3.amazonaws.com/AOST.png",
        tag="tv"
    )
    ...
    video2 = Video(
        title="Arcane",
        tmdb_id=94605,
        video_backdrop="https://www.themoviedb.org/t/p/original/q8eejQcg1bAqImEV8jh8RtBD4uH.jpg",
        video_url="https://endflix-seeds.s3.amazonaws.com/Acana.mp4",
        tite_url="https://endflix-seeds.s3.amazonaws.com/ArcaneT.png",
        tag="tv"
    )
    video3 = Video(
        title="Bullet Train",
        tmdb_id=718930,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/BTBD.webp",
        video_url="https://www.youtube.com/watch?v=0IOsk2Vlc4o&ab_channel=SonyPicturesEntertainment",
        tite_url="https://endflix-seeds.s3.amazonaws.com/BTT.webp",
        tag="movie"
    )
    video4 = Video(
        title="The Dark Knight Rises",
        tmdb_id=49026,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/TDKBD.webp",
        video_url="https://www.youtube.com/watch?v=GAjBzu8ggi0&ab_channel=WarnerBros.Entertainment",
        tite_url="https://endflix-seeds.s3.amazonaws.com/TDKT.webp",
        tag="movie"
    )
    ...
    video5 = Video(
        title="Demon Slayer: Kimetsu no Yaiba the Movie: Mugen Train",
        tmdb_id=635302,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/MugenBD.webp",
        video_url="https://www.youtube.com/watch?v=ATJYac_dORw&ab_channel=AniplexUSA",
        tite_url="https://endflix-seeds.s3.amazonaws.com/MUGENT.webp",
        tag="movie"
    )
    video6 = Video(
        title="Peaky Blinders",
        tmdb_id=60574,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/PBBD2.webp",
        video_url="https://www.youtube.com/watch?v=2nsT9uQPIrk&t=1s&ab_channel=BBC",
        tite_url="https://endflix-seeds.s3.amazonaws.com/PBT.png",
        tag="tv"
    )
    ...
    video7 = Video(
        title="The Irishman",
        tmdb_id=398978,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/TIMBD.webp",
        video_url="https://youtu.be/1Expe7hf6MU",
        tite_url="https://endflix-seeds.s3.amazonaws.com/TIMT.png",
        tag="movie"
    )
    ...
    video9 = Video(
        title="Hotel Del Luna",
        tmdb_id=90447,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/HDLBD.webp",
        video_url="https://www.youtube.com/watch?v=1IjMTR2DxlA&ab_channel=Ani-Hongo",
        tite_url="https://endflix-seeds.s3.amazonaws.com/HTLT.webp",
        tag="tv"
    )
    ...
    video10 = Video(
        ...
        tmdb_id=105248,
        video_backdrop="https://endflix-seeds.s3.amazonaws.com/CPBD.webp",
        video_url="https://youtu.be/x4ztgjvfU60",
        tite_url="https://endflix-seeds.s3.amazonaws.com/CPT.png",
        tag="tv"
    )
